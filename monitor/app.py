...
ACTIONABLE_SERVICES = {"instagram-stl-auto-dm", "instagram-stl-auto-dm-tunnel"}
...
app = FastAPI(title="Gustavo's Raspberry Status")
...
<head>
  ...
  <title>Gustavo's Raspberry Status</title>
    ...
    <section class="hero">
      <div class="hero-content">
        <div class="brand-row">
          ...
          <div>
            <h1>Gustavo's Raspberry Status</h1>
            <div class="subtitle" id="subtitle">Carregando dados...</div>
          </div>
        </div>
        <p class="hero-copy" id="hero-copy">Monitorando o Raspberry e o backend do Instagram Auto DM.</p>
      </div>
      <div class="hero-side">
